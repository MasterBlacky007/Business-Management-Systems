...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO leaves (userID, leaveDate, reason,status) 
            VALUES ('$eno', '$date', '$skill', 'Pending')";

    if (mysqli_query($conn, $sql)) {
        // Get the last inserted Employee ID
   
        echo "<script>alert('Leave Request successfully!'); window.location.href = 'empleave.php';</script>";
    } else {
   ...
   <nav class="sidebar">
    ...
    <main>
        <div class="container">
            ...
            <?php endif; ?>
            <form action="empleave.php" method="POST">
