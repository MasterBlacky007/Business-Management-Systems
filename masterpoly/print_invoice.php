...
<head>
    ...
    <style>
        ...
        /* Hide the print button once clicked */
        .print-button.hidden {
            display: none;
        }
...
<body>
    <div class="invoice-container">
        ...
        <button class="back-button" onclick="window.location.href='supdash.html'">Back to Dashboard</button>
        <button class="print-button" id="printBtn" onclick="printInvoice()">Print Invoice</button>
    </div>
