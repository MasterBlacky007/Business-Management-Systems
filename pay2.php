...
if (isset($_GET['orderId'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM addorder WHERE OrderID = ?");
...
<div class="container">
    ...
    <form action="payment_process2.php" method="POST" onsubmit="return validatePaymentStatus()">
        ...
        <label>IIC:</label>
        <input type="text" value="<?php echo htmlspecialchars($orderData['Email']); ?>" readonly>
        ...
        <!-- Back Button -->
        <button type="button" onclick="window.location.href='vieworder.php'" style="background-color: #007bff; margin-top: 10px; padding: 12px 25px; color: white; border: none; border-radius: 5px; cursor: pointer;">Back</button>
    </form>
</div>
</body>
</html>
